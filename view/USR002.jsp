    ...
    <div id="sub_content">
        ...
        <h2 class="col-md-6 offset-md-2 mb-5 mt-4">User Update</h2>
         <div class="row mb-4">
                ...
                <label for="username" class="col-md-2 col-form-label">UserID</label>
                <div class="col-md-4">
                    <input type="text" class="form-control" id="username" name="userid" value="${res.code}">
                </div>
            </div>
        <div class="row mb-4">
                <div class="col-md-2"></div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="password" class="form-control" id="name" name="password" value="${res.password}">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <select class="form-select" aria-label="Education" id="userRole" name="userrole">
                        <option selected value="admin" name="userrole" >Admin</option>
