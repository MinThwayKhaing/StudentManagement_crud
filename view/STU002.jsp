...
<marquee direction='up'style=color:red;>${error}</marquee>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control"  id="studentID" name="studentid" value="${param.studentid}">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="name" name="studentname" value="${param.studentname}">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
            ...
            <fieldset class="row mb-4">
                ...
                <div class="col-md-4">
                    <div class="form-check-inline">
                        <input class="form-check-input" type="radio" name="gridRadios" id="gridRadios1" value="male" name="gender" value="${param.gender}" 
                            checked>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    <input type="text" class="form-control" id="phone" plcaeholder="+95 097977323" name="phone" value="${param.phone}">
                </div>
            </div>
            <div class="row mb-4">
                <div class="col-md-2"></div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-4">
                    ...
                    onclick="location.href='StudentDeleteServlet?studentid=${param.studentid}'">
                    <span>
