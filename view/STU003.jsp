  ...
  <div id="testheader">
    ...
    <div id="sub_content">
      <form class="row g-3 mt-3 ms-2" action="StudentSearchServlet">
        <div class="col-auto">
          <label for="staticEmail2" class="visually-hidden" name="searchid">studentID</label>
          <input type="text"  class="form-control" id="staticEmail2" placeholder="Student ID">
        </div>
        <div class="col-auto">
          <label for="inputPassword2" class="visually-hidden" name="searchname">studentName</label>
          <input type="text" class="form-control" id="inputPassword2" placeholder="Student Name">
        </div>
        <div class="col-auto">
            <label for="inputPassword2" class="visually-hidden" name="course">Course</label>
      ...
      <table class="table table-striped" id="stduentTable">
        ...
        <c:forEach items="${list}" var="data">
          <tr>
            ...
            <td>
              <a href="StudentCourseDisplayServlet?studentid=${data.studentid}">See More</a> 
            </td>
